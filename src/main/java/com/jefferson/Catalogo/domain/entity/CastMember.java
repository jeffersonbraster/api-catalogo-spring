...
public class CastMember extends BaseEntity{ 
  ...
  public void setType(CastMemberType type) {
    if (name == null) throw new IllegalArgumentException("type is marked non-null but is null");
    if (!CastMemberType.valueOf(type)) throw new IllegalArgumentException("type is marked non-blank but is blank");
    this.type = type;
  }
